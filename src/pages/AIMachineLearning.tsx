...
const AIMachineLearning = () => {
  ...
  useEffect(() => {
    const fetchAIMachineLearningPosts = async () => {
      try {
        ...
        console.error('Error fetching AI & Machine Learning posts:', error);
      } finally {
        setLoading(false);
      }
    };

    fetchAIMachineLearningPosts();
  }, []);
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <h3 className="text-2xl font-semibold text-muted-foreground mb-4">
              No AI & Machine Learning posts yet
            </h3>
            <p className="text-muted-foreground">
              Check back soon for the latest AI and ML insights and analysis.
            </p>
          </div>
        ) : (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
